...
public class BubbleTester extends Application{
    ...
    private void runSimulation(int avgTimes){
        ...
        bubble1k = runAlgo(array1k, 1, bubbleSorter);
        bubble10k = runAlgo(array10k, 1, bubbleSorter);
        bubble100k = runAlgo(array100k, 1, bubbleSorter);
        bubble200k = runAlgo(array200k, 1, bubbleSorter);
    }
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        barChart.setTitle("Execution times for Bubble Sort");
