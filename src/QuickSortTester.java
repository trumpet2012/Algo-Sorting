...
public class QuickSortTester extends Application{
    ...
    private void runSimulation(int avgTimes){
        ...
        quickSort1k = runAlgo(array1k, 1, quickSorter);
        quickSort10k = runAlgo(array10k, 1, quickSorter);
        quickSort100k = runAlgo(array100k, 1, quickSorter);
        quickSort200k = runAlgo(array200k, 1, quickSorter);
    }
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        barChart.setTitle("Execution times for Quick Sort");
